<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Update.aspx.cs" Inherits="BasicWeb.Update" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <h1 style="color: red; text-align: center">Update Page</h1>
            <table align="center">
                <tr>
                    <td>
                ...
                <tr align="center">
                    <td colspan="2">
                        ...
                        <asp:Button ID="btnShow" Text="Show Data" runat="server" OnClick="btnShow_click" />
                    </td>
                </tr>
            </table>
        </div>
